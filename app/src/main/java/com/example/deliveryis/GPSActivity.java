...
public class GPSActivity extends AppCompatActivity implements ConnectionCallbacks, OnConnectionFailedListener{
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(GPSActivity.this, new
